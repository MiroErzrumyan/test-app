...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)(['removeAuth'])), {}, {
    logout: function logout() {
      var _this = this;

      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var response, success, _response;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapMutations)(['SET_USER'])),
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (Object.keys(_this.user).length) {
                _context.next = 20;
                break;
              }
            ...
            case 6:
              ...
              if (!(_this.$route.fullPath === '/login' || _this.$route.fullPath === '/register')) {
                _context.next = 12;
                break;
              }
                ...
                [
                  _c(
                    "router-link",
                    {
                      ...
                      staticClass: "text-dark fs-5  text-decoration-none mx-4",
                      attrs: { to: "/login" },
                    },
                    [_vm._v("Login\n                    ")]
                  ),
